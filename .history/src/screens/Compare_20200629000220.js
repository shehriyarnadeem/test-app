...
const Compare = ({ navigation }) => {
  ...
  const DATA3 = [
    ...
    {
      id: "bd7acbea-c1b1-46c2-aed5-23ad53asbb282dfba",
      title: "First Item",
      // image: Product2,
    },
    {
      id: "bd7acbea-c1b1-46c2-aed5-a3ad53absb281df2ba",
      title: "First Item",
      // image: Product2,
    },
    {
      id: "bd7acbea-c1b1-46c2-aed5-s3ad53abbs282bdfa",
      title: "First Item",
      // image: Product2,
    },
    {
      id: "bd7acbea-c1b1-46c2-aed5-dd3ad53abdsb2812badf",
      title: "First Item",
      // image: Product2,
    },
  ];
  ...
  return (
    <View style={styles.container}>
      <Card width="93%" height={500} borderRadius={45}>
        <TouchableHighlight
