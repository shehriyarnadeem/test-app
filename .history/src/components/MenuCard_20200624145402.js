...
const MenuCard = ({ showChecboxHandler, activeTab, setScreen }) => {
  console.log(activeTab, "sds");
    ...
    >
      <View style={styles.middleCard}>
        ...
        >
          ...
          >
            <Image
              source={activeTab === "share" ? ShareActive : ShareInActive}
        ...
        >
          ...
          >
            <Image
              source={activeTab === "compare" ? CompareActive : CompareInActive}
              style={styles.middleCardIcon}
            />
        ...
        <View style={{ left: -20 }}>
          <Image
            source={activeTab === "poll" ? PollActive : PollInActive}
            style={styles.middleCardIcon}
          />
