...
export default class MyComponent extends React.Component {
  ...
  state = {
    ...
    routes: [
      ...
      { key: "sample1", title: "Home", icon: "queue-music" },
      { key: "sample2", title: "Home", icon: "queue-music" },
      { key: "sample3", title: "Home", icon: "queue-music" },
      { key: "sample4", title: "Home", icon: "queue-music" },
    ],
  };
